...
public class Exercicio04 {
    public static void main(String[] args) {
        Collection<Double> resultadosCalculadora = new ArrayList<>();
        String  end = "";
        ...
        do {
            ...
            resultadosCalculadora.add(result);
        ...
        resultadosCalculadora.forEach(itemCalculadora -> System.out.println(itemCalculadora));
    }
}
